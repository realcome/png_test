...

{
  ...
  'targets': [
    {
      ...
      'conditions': [
        ...
        ['OS!="ios" and OS!="android" and chromecast==0 and enable_google_sync==1', {
          'dependencies': [
            # TODO: This should build on Android and the target should move to the list above.
            '../sync/sync.gyp:*',
            '../sync/tools/sync_tools.gyp:*',
  ...
  'conditions': [
    ...
    ['OS=="win"', {
      'targets': [
        {
          'target_name': 'convert_crx_to_srx',
          'type': 'none',
          'dependencies': [
            '../chrome/tools/convert_crx_to_srx/convert_crx_to_srx.gyp:convert_crx_to_srx',
          ],
        },  # target_name: macviews_builder
      ],  # targets
    }],
